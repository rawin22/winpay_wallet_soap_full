...
{
    public class NewDepositViewModel : BaseViewModel
    {
        ...
        public NewDepositViewModel(Guid? paymentId)
            : this()
        {
        ...
        public NewDepositViewModel(string alias, string ccy, decimal amount, string invoice, string memo)
            : this()
        {
            PrepareDetails(alias, ccy, amount, invoice, memo);
        }

        public NewDepositViewModel(string alias, string ccy, decimal amount, string invoice, string memo, Guid receiveId)
            : this()
        {
        ...
        /// <summary>
        /// Create deposit instant payment
        /// </summary>
        /// <param name="paymentId">Payment ID output </param>
        /// <param name="paymentReference">Payment Reference output</param>
        public void Create(out Guid paymentId, out string paymentReference)
        {
            // Create instant payment for deposit
            // paymentTypeId: 2 = Deposit
            var response = Service.CreateInstantPayment(MerchantAlias, CustomerAlias, Amount, CurrencyCode, 2);
        ...
        /// <summary>
        /// Prepare instant payment details
        /// </summary>
