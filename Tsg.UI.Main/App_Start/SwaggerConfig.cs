...
namespace Tsg.UI.Main
{
    public class SwaggerConfig
    {
        public static void Register()
        {
            ...
            GlobalConfiguration.Configuration
                .EnableSwagger("docs/{apiVersion}/", c =>
                {
                    ...
                    //
                    //c.SingleApiVersion("v1", "Tsg.UI.Main");
                    ...
                    c.ApiKey("8A1DACA4-144F-48C6-A68B-E9B2EC38A7E5")
                        .Description("API Key Authentication")
                        .Name("X-APIKEY")
                        .In("header");
                    c.SingleApiVersion("v1", "TSG Mobile Api Docs");
        ...
        {
            return string.Format(@"{0}\bin\TSGMobileApi.xml", AppDomain.CurrentDomain.BaseDirectory);
        }
    }
}
