...
{
    [ApiFilter]
    public class ApiMiniKycRegistrationController : ApiController
    {
        ...
        public ApiMiniKycRegistrationController(IKycNewUserServiceMethods kycNewUserService, IUsersServiceMethods usersServiceMethods)
        {
        ...
        [HttpPost]
        public IHttpActionResult Post([FromBody] MiniKycAddNewUser model)
        {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    try
                    {
                        ...
                        if (!resultStep1.Success)
                            return Content(HttpStatusCode.BadRequest, (resultStep1 as StandartResponse) ?? new StandartResponse("Error", "Customer create from template start step error"));
                    }
                    catch (Exception e)
                    {
                        _logger.Error(e);
                        return Content(HttpStatusCode.BadRequest,
                            new StandartResponse("Error in KYC process",
                                $"Step 1: {e.Message + Environment.NewLine + e.InnerException?.Message}"));
                    }
                    ...
                    try
                    {
                        ...
                        if (!resultStep2.Success)
                            return Content(HttpStatusCode.BadRequest, (resultStep2 as StandartResponse) ?? new StandartResponse("Error", "Customer create from template start step error"));
                    }
                    catch (Exception e)
                    {
                        _logger.Error(e);
                        return Content(HttpStatusCode.BadRequest,
                            new StandartResponse("Error in KYC process",
                                $"Step 2: {e.Message + Environment.NewLine + e.InnerException?.Message}"));
                    }
                    ...
                    try
                    {
                        ...
                        if (!resultStep3.Success)
                            return Content(HttpStatusCode.BadRequest, (resultStep3 as StandartResponse) ?? new StandartResponse("Error", "Customer create from template start step error"));
                    }
                    catch (Exception e)
                    {
                        _logger.Error(e);
                        return Content(HttpStatusCode.BadRequest,
                            new StandartResponse("Error in KYC process",
                                $"Step 3: {e.Message + Environment.NewLine + e.InnerException?.Message}"));
                    }
                    ...
                    {
                        return Content(HttpStatusCode.BadRequest, new StandartResponse("Invalid user data login/password"));
                    }
                    ...
                    return Ok(new StandartResponse<Tuple<string, Guid, string>>(new Tuple<string, Guid, string>(userAlias, insertKycRes.Obj.Id, model.EmailAddress), 
                        true, "KYC user created successfully"));
                }
                else
                {
                    return Content(HttpStatusCode.BadRequest, new StandartResponse(false, "Invalid model",
