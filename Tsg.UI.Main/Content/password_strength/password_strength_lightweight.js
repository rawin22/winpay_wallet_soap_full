...
; (function ($, window, document, undefined) {
    ...
    Plugin.prototype._create = function () {
            ...
            <ul> \
            <li data-criterion="length" class="invalid"> Password must be at least <strong>8 Characters long or more</strong></li> \
            ...
            <li data-criterion="specs" class="invalid">At least <strong>one Special symbol [!,@,#,$,%,^,&,*,?,_,~,-,(,)]</strong></li> \
        ...
        Plugin.prototype._bind_input_events = function ($s) {
            ...
            $s.bind('keyup', function () {
                ...
                var specs = password.match(specSymbols) ? 1 : 0;

                var total = characters + capitalletters + loweletters + number+specs;
