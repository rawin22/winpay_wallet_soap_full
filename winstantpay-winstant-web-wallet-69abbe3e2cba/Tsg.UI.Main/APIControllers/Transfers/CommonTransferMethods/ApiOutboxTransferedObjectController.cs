...
{
    [ApiFilter]
    public class ApiOutboxTransferedObjectController : ApiController
    {
        readonly log4net.ILog _logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        private readonly IGetInboxListMethods _getInboxListMethods;
        public ApiOutboxTransferedObjectController(IGetInboxListMethods getInboxListMethods)
        {
        ...
        public IHttpActionResult Get()
        {
            ...
            try
            {
                ...
                {
                    var resQuery = _getInboxListMethods.GetByParent(ui.UserName).Obj;
                    resQuery.ForEach(f =>
                    {
