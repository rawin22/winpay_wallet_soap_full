...
namespace Tsg.Business.Model.Classes
{
	public class IgpService
	{
		...
		public CurrencyListGetResponse GetFXBuyCurrencies()
		{
			return _service.CurrencyListGetFXBuyCurrencies();
		}

		public CurrencyListGetResponse GetFXSellCurrencies()
		{
			return _service.CurrencyListGetFXSellCurrencies();
		}
